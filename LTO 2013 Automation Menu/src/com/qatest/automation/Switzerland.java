...
public class Switzerland {
  ...
  @Test
  public String[] testSwitzerland(boolean place, boolean screenshot, String location) throws Exception {
  ...
  public String[] Myself(boolean place, boolean screenshot, String location)
  {
	  try{
		...
		if (results[0] != null)
		{
			results[0] = "Switzerland: Failed: Myself\n" + results[0];
			if (screenshot)
				myScreenShot.takeScreenShot(location, "Switzerland");
			return results;
		}
	  ...
	  {
		  results[0] = "Switzerland: Script Error: Buy for myself\n"+ "URL: " + driver.getCurrentUrl() + "\n" + "Script Error: " + e;
		  if (screenshot)
				myScreenShot.takeScreenShot(location, "Switzerland");
		  return results;
	  }
