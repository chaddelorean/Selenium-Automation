...
public class FrenchPolynesia {
  ...
  @Test
  public String[] testFrenchPolynesia(boolean place, boolean screenshot, String location) throws Exception {
  ...
  public String[] Myself(boolean place, boolean screenshot, String location)
  {
	  try{
        ...
        LTO2013Menu.getLog().appendLog(data.getDistID(), data.getBuyerID(), ordernum[3], "French Polynesia");
	    return results;
	  }
	  
	  catch (Exception e)
	  {
		  results[0] = "French Polynesia: Buy for Myself \n"+ "URL: " + driver.getCurrentUrl() + "\n" +  "Script Error: " + e;
		  if (screenshot)
				myScreenShot.takeScreenShot(location, "FrenchPolynesia");
		  return results;
	  }
