...
public class Iceland {
  ...
  @Test
  public String[] testIceland(boolean place, boolean screenshot, String location) throws Exception {
  ...
  public String[] Myself(boolean place, boolean screenshot, String location)
  {
	  try{
        ...
        LTO2013Menu.getLog().appendLog(data.getDistID(), data.getBuyerID(), ordernum[3], "Iceland");
	    return results;
	  }
	  
	  catch (Exception e)
	  {
		  results[0] = "Iceland: Script Error: Buy for myself\n"+ "URL: " + driver.getCurrentUrl() + "\n" + "Script Error: " + e;
		  if (screenshot)
				myScreenShot.takeScreenShot(location, "Iceland");
		  return results;
	  }
